...
<div class="image-container">
    <span class="image-margin">
        <Image imageName="services-openssh-min.png" alt="services-openssh" desc="Windows Service OpenSSH" imageProps ='{{ width:"300px", height: "300px", objectFit: "cover", borderRadius:"10p", position:"center", figureWith:"auto"}}' />
    </span>
   <span class="image-margin">
